...
module GovukRailsBoilerplate
  class Application < Rails::Application
    ...
    api_credentials = Rails.application.credentials.api || {}
    ...
    Rails.configuration.x.default_user.username = ENV.fetch("DEFAULT_USER_USERNAME", default_user_credentials[:username])
    Rails.configuration.x.default_user.password = ENV.fetch("DEFAULT_USER_PASSWORD", default_user_credentials[:password])
  end
end
